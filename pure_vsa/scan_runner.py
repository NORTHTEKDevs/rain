...
def main():
    ...
    print("=" * 72)
    print("NOTE: this file is the SCAN data loader + grammar parser + ORACLE")
    print("verifier. It is NOT the pure-VSA solver and does NOT produce the")
    print("100% result. For the actual mechanism and headline accuracy, run:")
    print("    python -m pytest tests/test_scan_hyperion.py -v")
    print("or use pure_vsa.scan_hyperion.SCANHyperion (see README).")
    print("The 'fraction the mechanism could attempt' line below is a stale")
    print("v0.1 diagnostic and does NOT reflect SCANHyperion's coverage (100%).")
    print("=" * 72)
    ...
    print("\n[STALE v0.1 DIAGNOSTIC] atom_only+atom+mod cases this OLD harness")
    print("could attempt -- NOT the real solver's coverage:")
    print(f"  {n_in_scope}/{len(test)} = {n_in_scope / len(test):.1%}")
    print("The real solver (pure_vsa.scan_hyperion.SCANHyperion) handles ALL of")
    print("these structures at 100%. Run the pytest command shown above.")
